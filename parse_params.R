...
parse_inputs <- function(input_file) {
  ...
  input_params$init_ppl_file <- get_item(inputs$init_ppl$val, defaults$init_ppl$val)

  # program data
  input_params$program_data <- get_item(inputs$program_data$val, defaults$program_data$val)
