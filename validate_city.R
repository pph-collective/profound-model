...
write.xlsx(ODdeaths16, file="CityLevelValidation.xlsx", sheetName = "2016",
           col.names = F, row.names = T)
write.xlsx(ODdeaths17, file="CityLevelValidation.xlsx", sheetName = "2017", append=TRUE,
           col.names = F, row.names = T)
write.xlsx(ODdeaths18, file="CityLevelValidation.xlsx", sheetName = "2018", append=TRUE,
           col.names = F, row.names = T)
write.xlsx(ODdeaths19, file="CityLevelValidation.xlsx", sheetName = "2019", append=TRUE,
           col.names = F, row.names = T)